...
class RitualPeople extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  RitualPeople(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> updatedAt = GeneratedColumn<String>(
    'updated_at',
    aliasedName,
    false,
  ...
  @override
  RitualPeople createAlias(String alias) {
    return RitualPeople(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(ritual_id, person_id)',
  ];
  @override
  bool get dontWriteConstraints => true;
}
...
class Users extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> avatarMediaId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NULL REFERENCES media_items(id)ON DELETE SET NULL',
  );
  @override
  List<GeneratedColumn> get $columns => [
    id,
...
class OutboxEntries extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class DatabaseAtV8 extends GeneratedDatabase {
  ...
  late final RitualPeople ritualPeople = RitualPeople(this);
